...
par(cex.lab = 0.95, cex.axis = 0.85, mfcol = c(2,2), mar = c(4,4,1,1))
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = c(1,1,1), col = c("black", "red", "blue"), bty = "n", pt.cex = 1, cex = 0.8)

with(twoDay, plot(Voltage~datetime, type = "l"))

with(twoDay, plot(Global_reactive_power~datetime, type = "l"))
